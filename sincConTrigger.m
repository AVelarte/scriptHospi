...
% Ponemos la ruta a la carpeta de los datos
...
% El último valor hace refencia hasta que frecuencia se representa del espectro
datos_notch = grafSignal(canal, tiempos, true, true, 1000);  
datos_stackSign = makeStack(datos_notch, tiempos, loc_peak);
%% Eliminamos los 50Hz de la excitación y hacemos el stacking de los canales deseados (esto es fuera del tejido)
